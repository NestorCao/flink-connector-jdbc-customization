...
# [INFO] ------------------------------------------------------------------------
# [INFO] Building org.apache.flink-java 1.0-SNAPSHOT
# [INFO] ------------------------------------------------------------------------
# [INFO]
# [INFO] --- maven-dependency-plugin:2.8:tree (default-cli) @ org.apache.flink-java ---
# [INFO]

### Example of a Scala dependent module:
# [INFO] ------------------------------------------------------------------------
# [INFO] Building org.apache.flink-storm 1.0-SNAPSHOT
# [INFO] ------------------------------------------------------------------------
# [INFO]
# [INFO] --- maven-dependency-plugin:2.8:tree (default-cli) @ org.apache.flink-storm ---
# [INFO] org.apache.flink:org.apache.flink-storm:jar:1.0-SNAPSHOT
# [INFO] \- org.apache.flink:org.apache.flink-streaming-java:jar:1.0-SNAPSHOT:compile
# [INFO]    \- org.apache.flink:org.apache.flink-runtime:jar:1.0-SNAPSHOT:compile
...
BEGIN="[INFO] Building org.apache.flink"
SEPARATOR="[INFO] ------------------------------------------------------------------------"
END=$SEPARATOR
...
# exclude e2e modules and org.apache.flink-docs for convenience as they
# a) are not deployed during a release
# b) exist only for dev purposes
# c) no-one should depend on them
e2e_modules=$(find org.apache.flink-end-to-end-tests -mindepth 2 -maxdepth 5 -name 'pom.xml' -printf '%h\n' | sort -u | tr '\n' ',')
excluded_modules=\!${e2e_modules//,/,\!},!org.apache.flink-docs,!org.apache.flink-end-to-end-tests
...
while read line; do
    if [[ $line == *"$BEGIN"* ]]; then
        reached_block=1
        # Maven module name
        block_name=`[[ "$line" =~ .*(org.apache.flink-?[-a-zA-Z0-9.]*).* ]] && echo ${BASH_REMATCH[1]}`
