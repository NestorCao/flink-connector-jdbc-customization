...
MVN_VALIDATION_DIR="/tmp/org.apache.flink-validation-deployment"
...
# use the same invocation as on buildbot (https://svn.apache.org/repos/infra/infrastructure/buildbot/aegis/buildmaster/master1/projects/org.apache.flink.conf)
