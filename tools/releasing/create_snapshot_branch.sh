...
url_base="//ci.apache.org/projects/org.apache.flink/org.apache.flink-docs-release-"
...
perl -pi -e "s#dev-master#dev-${SHORT_RELEASE_VERSION}#" ../org.apache.flink-end-to-end-tests/test-scripts/common_docker.sh
